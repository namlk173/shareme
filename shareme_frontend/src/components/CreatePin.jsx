    ...
    <div className="flex flex-col justify-center items-center mt-5 lg:h-4/5">
      ...
      <div className="flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
          ...
          />
          {user && (
            <div className="flex gap-2 my-1 items-center bg-white rounded-lg">
              <img
                src={user.image}
                alt="user-profile"
          ...
          <div className="flex flex-col">
            <div>
              ...
              <select
                ...
                className="outline-none w-4/5 text-base boder-b-2 border-gray-200 p-2 rounded-md cursor-pointer"
              >
                ...
                {categories.map((category) => (
                  <option
                    className="text-base boder-0 outline-none capitalize bg-white text-black"
                    value={category.name}
                    key={category.name}
                  >
                    {category.name}
