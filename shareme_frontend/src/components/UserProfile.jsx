...
const UserProfile = () => {
  ...
  return (
    <div className="relative pb-2 h-full justify-center items-center md:ml-300">
      <div className="flex flex-col pb-5">
        <div className="relative flex flex-col mb-7">
          <div className="flex flex-col justify-center items-center">
            <img
              src={randomImage}
              alt="backgound-profile"
            ...
            <div
              className="absolute top-2 z-1 right-2 p-2 bg-white rounded-full cursor-pointer"
